...
contract AugmintToken is AugmintTokenInterface {
    ...
    function delegatedTransfer(address from, address to, uint amount, string narrative,
                                     uint minGasPrice,  /* client provided minimum gasPrice in wei
                                                            which she expects tx to be executed */
    ...
    external {
        ...
        bytes32 txHash = keccak256(this, from, to, amount, narrative, minGasPrice, maxExecutorFeeInToken, nonce);
