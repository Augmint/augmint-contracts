...
module.exports = function(deployer) {
    deployer.then(async () => {
        ...
        console.log(" Done with migration step 32. Updating truffle Migrations step manually");
        await Migrations.at("0xb96f7e79a6b3faf4162e274ff764ca9de598b0c5").setCompleted(32);
    });
};
