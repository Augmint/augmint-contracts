...
const MIGRATION_STEP_NUMBER = 30;
...
module.exports = function(deployer) {
    deployer.then(async () => {
        ...
        // ### PreTokenProxy ###
        await deployer.deploy(PreTokenProxy);

        // ### PreToken ###
        await deployer.deploy(PreToken, StabilityBoardProxy.address);   // temporary for preToken, init script will change it to preTokenProxy
