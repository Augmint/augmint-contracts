...
const Main0013_initNewExchange = artifacts.require("./Main0013_initNewExchange.sol");
...
module.exports = function(deployer) {
    deployer.then(async () => {
        await deployer.deploy(Main0013_initNewExchange);

        console.log(" Done with migration step 29. Updating truffle Migrations step manually");
        await waitForInfuraNonce();
        
        await Migrations.at("0xE7E9f87805C0BEC5108963D07f85e4cA5892D421").setCompleted(29);
    });
};
