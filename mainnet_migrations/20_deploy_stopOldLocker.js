/* Deploy script to disable all products in old locker contract
*/
const Migrations = artifacts.require("./Migrations.sol");
const Main0007_stopOldLocker = artifacts.require("./Main0007_stopOldLocker.sol");
...
module.exports = function(deployer) {
    deployer.then(async () => {
        await deployer.deploy(Main0007_stopOldLocker);

        await waitForInfuraNonce();

        console.log(" Done with migration step 20. Updating truffle Migrations step manually");
        await Migrations.at("0xE7E9f87805C0BEC5108963D07f85e4cA5892D421").setCompleted(20);
    });
};
